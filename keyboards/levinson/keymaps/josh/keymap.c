...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL, MO(4), SCMD(xxxxxxx), MO(2), MO(3), KC_LSFT, KC_SPC, MO(1), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT),
	...
	[1] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL, xxxxxxx, SCMD(xxxxxxx), KC_F1,  KC_F2,  KC_F3,  KC_SPC,  _______, KC_0, KC_PDOT, xxxxxxx, KC_PPLS),
	...
	[2] = LAYOUT_ortho_4x12(
      ...
      KC_LCTL, xxxxxxx, SCMD(xxxxxxx), _______, xxxxxxx, KC_LSFT, xxxxxxx, xxxxxxx, KC_HOME, KC_PGDN, KC_PGUP, KC_END),
